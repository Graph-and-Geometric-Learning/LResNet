...
from manifolds.geoopt import ManifoldParameter
from manifolds.geoopt.optim import RiemannianAdam, RiemannianSGD
...
def select_model(img_dim, num_classes, args):
    ...
    enc_args = {
        ...
        'bias' : args.encoder_manifold=="lrn"
    }

    if args.encoder_manifold=="lrn":
